...
+ REvisar a localização IA e Aprendizagem de Máquina:  https://www.instagram.com/p/DWWw9NBEWzo/ FEITO
...
+ Remover coloquialismo: "O Q-Learning é um algoritmo de reforço que consiste em dar Q-Values(valores de qualidade) para uma determinada ação da rede," FEITO
...
As complexidades são reduzidas quando utilizadas as explorações de forma gulosa, ja que os problemas não precisam encontrar uma melhor solução apenas umas solução que atenda o interesse imediato. FEITO
+ Definir todas as categorias FEITO
+ Ás como valor 13 -> Consertar para Às como 14. FEITO
+ "Levando em consideração que a" -> Considerando FEITO
+ Deixar de explicar o kicker na parte do motor de avaliação base 15, já que o mesmo já foi explicado FEITO