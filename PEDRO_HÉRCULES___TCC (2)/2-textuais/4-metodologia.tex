...
Para contornar isso, foi elaborado um sistema de \textit{score}(pontuação) de base 15, tomando o \textit{Ás} como valor 13, a base 15 supre todas as necessidades do sistema, garantindo que não haverão possibilidades maiores que o ás, para calcular esse score é usada a seguinte formula:
