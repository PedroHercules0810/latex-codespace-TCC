...
O gráfico demonstra o decaimento do fator de exploração \textit{epsilon} ($\epsilon$), sendo possível notar que a partir de por volta do jogo 500, a taxa de exploração é mínima, significando que o agente esta jogando com tudo o que aprendeu, ao invés de apenas tomar ações aleatórias.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.97\linewidth]{lib/Desempenho do agente.jpeg}
