...
\graduacaoem{INTERDISCIPLINAR EM TECNOLOGIA DA INFORMAÇÃO}
...
\titulo{\textbf{Inteligência Artificial Aplicada ao Texas Hold'em}: Uma Abordagem com Aprendizado por Reforço Profundo e Algoritmo de Predição Monte Carlo}
\data{2026}
\local{Pau dos Ferros}

% Exemplo: \dataaprovacao{01 de Janeiro de 2023}
\dataaprovacao{23 de Junho de 2026}
...
\imprimirindice
\appendix
\include{3-pos-textuais/apendices/apendice-a}
